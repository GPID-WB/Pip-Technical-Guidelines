...
- Indicate relevant code (sekect a file or highlight the specific piece of code)  
...
- what verbs are more useful to be clearer to the agent (Give examples of senteces). And what is the best structure of a prompt
- what to avoid about prompts

## First Ask, then activate Agent: map and agree the solution first
...
This can improve the answer from copilot
