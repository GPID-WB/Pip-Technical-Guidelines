...
- Confirm you have a working Python/Windows environment set up (see the [Prerequisites](mAI_factory_API_setup_prerequisities.qmd)) so you're ready to configure credentials as soon as access is granted.
