...
3. **Agent \@workspace**: You can use the Agent \@workspace feature to give Copilot access to your entire project directory. This allows Copilot to see all files and folders in your project, making it easier to understand the context of your work.
...
::: {.callout-tip icon="false" appearance="simple" title="Prompt"}
