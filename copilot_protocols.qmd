---
title: "Mandatory Protocols for Using GitHub Copilot in Technical Work"
abstract: this document outlines mandatory protocols and recommended guidelines for using GitHub Copilot in technical work, ensuring productivity while maintaining code quality and team skills.
execute:
  eval: false
---
...
## Protocol 1 — Documenting Your Work With Copilot {.unnumbered}
...
## Protocol 2 — Making the Code Understandable {.unnumbered}
...
Identify any cases where this code might break.
:::
...
Write a short, plain-language explanation of how this code works.
Pretend you're explaining it to a teammate seeing it for the first time.
:::
...
## Protocol 3 — Testing and Edge Cases {.unnumbered}
...
Create a validation checklist for this code.
Include:
...
Generate `testthat` unit tests for this code.
Cover:
...
Generate Stata tests (do-file assertions or checks) for this code.
Cover:
...
### (Optional but Recommended) Ask Copilot to Suggest Performance-Sensitive Tests {.unnumbered}
...
Suggest performance-sensitive tests for this code.
Identify:
...
## Protocol 4 — Dependencies, Risks, and Final Validation Bundle {.unnumbered}
...
### Why These Protocols Matter {.unnumbered}
...
### (EXTRA) Prompt Files Are Optional Tools, Not Documentation {.unnumbered}
